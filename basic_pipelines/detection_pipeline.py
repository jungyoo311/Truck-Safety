...
class GStreamerDetectionApp(GStreamerApp):
    def __init__(self, app_callback, user_data):
        ...
        parser.add_argument(
            "--network",
            default="yolov10s",
            # choices=['yolov6n', 'yolov8s', 'yolov10s'],
            choices=[ 'yolov10s'],
            help="Which Network to use, default is yolov10s",
        )
        parser.add_argument(
            "--hef-path",
            default=None,
        ...
        elif args.network == "yolov10s":
            self.hef_path = os.path.join(self.current_path, '../resources/yolov10s.hef')
        else:
